...
public sealed class EnvResolver(ISecretStore secrets)
{
    ...
    {
        // File-sourced values arrive already variable-expanded (see
        // ProjectSecretScanner.ReadEnvFiles); Keychain secrets are merged verbatim so a
        // secret value containing '$' is never substituted.
